...
const FOOTER_EXPLORE=[["Home","/"],["SAT Prep","/founder-cohort"],["Register","/register"],["Login","/login"],["For Parents","/parent-webinar"],["Contact Us","/contact"],["Privacy Policy","/privacy"],["Terms of Service","/terms"]] as const;

...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith("/admin")) {
    ...
    const FOUNDER_ONLY_PREFIXES = ["/admin/access", "/admin/o-level-access", "/admin/o-level-applications", "/admin/parents", "/admin/o-level-parents", "/admin/punjab-9th-parents", "/admin/teachers", "/admin/quiz", "/admin/scholarships"];

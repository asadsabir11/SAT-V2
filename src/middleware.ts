...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith("/admin")) {
    ...
    const FOUNDER_ONLY_PREFIXES = ["/admin/access", "/admin/o-level-access", "/admin/o-level-applications", "/admin/parents", "/admin/o-level-parents", "/admin/punjab-9th-parents", "/admin/teachers", "/admin/teacher-applications", "/admin/quiz", "/admin/scholarships"];
...
export const config = {
  matcher: ["/dashboard/:path*", "/sat", "/admin/:path*", "/diagnostic", "/ai-tutor", "/lectures", "/lectures/:path*", "/sessions", "/sessions/:path*", "/quizzes", "/quizzes/:path*", "/discussion", "/discussion/:path*", "/unlock", "/unlock/:path*", "/fees", "/fees/:path*", "/notifications", "/notifications/:path*", "/o-level/lectures", "/o-level/lectures/:path*", "/o-level/quizzes", "/o-level/quizzes/:path*", "/o-level/sessions", "/o-level/sessions/:path*", "/o-level/past-papers", "/o-level/past-papers/:path*", "/o-level/unlock", "/o-level/unlock/:path*"],
};

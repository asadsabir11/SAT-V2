...
export interface Notification {
  ...
  program: "sat" | "o-level" | "punjab-9th" | "amna-shamima" | null;
...
export async function listNotificationsForStudent(studentUserId: string, program: "sat" | "o-level" | "punjab-9th" | "amna-shamima", limit = 30): Promise<Notification[]> {
  await ensureTable();
